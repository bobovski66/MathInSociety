...
\begin{enumerate}
\item A filled rectangle and a crescent-shaped region are drawn on the same page. Which one is convex? Use the definition of convexity to explain your answer in one sentence.
\workmed
...
\item Determine whether \((2,3)\) is feasible.
\item Determine whether \((4,3)\) is feasible.
\end{enumerate}
\worklarge
...
\item A feasible polygon has vertices \((0,0),(6,0),(4,3),(0,5)\). Evaluate \(f=3x+2y\) at all four vertices. Two adjacent vertices tie for the maximum. What does that imply about the edge connecting them?
\worklarge
\end{enumerate}
