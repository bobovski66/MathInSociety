...
\item Use the Rule of 72 for an investment growing at approximately \(9\%\) per year.
\begin{enumerate}[label=(\alph*),itemsep=4pt]
...
\item A \(\$4000\) loan charges \(6\%\) APR compounded monthly. The borrower pays \(\$175\) at the end of each month.
\begin{enumerate}[label=(\alph*),itemsep=4pt]
...
\item Loan A and Loan B both begin at \(\$5000\) with the same APR. Loan A requires \(\$150\) each month and Loan B requires \(\$250\). Do the two loans have the same first-month interest charge? Which payment removes more principal in month 1?
\workmed
\end{enumerate}
