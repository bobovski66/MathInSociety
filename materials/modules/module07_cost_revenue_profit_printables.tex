...
\begin{enumerate}
\item A tutoring business has fixed weekly costs of \(\$180\). Each tutoring session creates \(\$6\) in variable costs, and students are charged \(\$18\) per session.
...
\item Using the tutoring business from Problem 1, suppose \(25\) sessions are provided in one week. Find the total cost, total revenue, and profit. State whether the business is operating at a profit or a loss.
\worklarge

\item Find the break-even number of tutoring sessions for the business in Problem 1. If the break-even quantity is a whole number, explain what happens to profit at one session below break-even and one session above break-even.
\worklarge
