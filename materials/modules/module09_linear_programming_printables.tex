...
\begin{enumerate}
\item A farmer plants corn \((x\) acres\()\) and soybeans \((y\) acres\()\). Corn requires \(3\) labor-hours per acre and earns \(\$200\) profit per acre. Soybeans require \(2\) labor-hours per acre and earn \(\$150\) profit per acre. The farmer has at most \(120\) labor-hours and \(50\) acres of land.
\begin{enumerate}[label=(\alph*),itemsep=4pt]
\item Write the labor constraint.
\item Write the land constraint.
...
\qquad x,y\ge0.
\]
The feasible vertices are \((0,0),(8,0),(4,6),(0,8)\). Evaluate \(f\) at all four vertices and identify the optimal point.
\worklarge

\item A cost problem has minimum requirements:
\[
x+y\ge8,
\qquad 2x+y\ge10,
\qquad x,y\ge0,
\]
and objective \(C=3x+5y\). The relevant boundary vertices are \((8,0),(2,6),(0,10)\). Evaluate the cost at each point and identify the minimum.
\worklarge
