...
\]
\begin{itemize}
\item \(\mathbb N\): natural numbers \(1,2,3,\ldots\). In this course, \(0\notin\mathbb N\), so \(0\) is first classified as an integer.
...
\item Which quantity is constant from year to year: the difference between consecutive terms or the ratio of consecutive terms?
\end{enumerate}
\worklarge
\end{enumerate}
