...
\item The practical question in this course is whether the \textbf{selection method systematically overrepresents or underrepresents} parts of the population.
\end{itemize}
Random selection is useful because it gives a broader cross-section of the population than selecting people only from one convenient time or place.
\end{keybox}
