...
\begin{keybox}{Population, sample, and representativeness}
\begin{itemize}
...
\item Every realized sample is only a partial view of the population and will differ from it in some ways.
\item When judging a sampling method, ask whether the \textbf{selection process systematically overrepresents or underrepresents} parts of the population.
\end{itemize}
Random selection can reduce systematic overrepresentation or underrepresentation compared with selecting people only from one convenient time or place, although any realized sample is still only a partial view of the population.
\end{keybox}
...
\textbf{By the end of this module, you should be able to:} identify a population and sample; describe how a sampling method may overrepresent or underrepresent part of a population; build a frequency and relative-frequency table; choose a bar chart or histogram appropriately; verify a probability distribution; and use complements.
...
\item What part of the student population is not represented by this selection rule, and why might that matter when using the sample to describe the whole college?
\end{enumerate}
\workxl
...
\begin{enumerate}
\item A county wants to estimate support for a new park levy. A polling organization randomly selects \(500\) registered county voters. Identify the population and the sample. What feature of the selection plan is intended to give a broad cross-section of the registered-voter population?
\workmed
