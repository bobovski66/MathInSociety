...
\textbf{Prequiz}
\begin{enumerate}
\item Population: \textbf{all students at the college}. Sample: \textbf{the 150 students in classes before 9 a.m.} The sample may be biased because students who take very early classes may have different work schedules than students who do not.
\item Bus:
\[
\frac6{24}=\boxed{0.25}.
\]
...
\textbf{Matching quiz}
\begin{enumerate}
\item Population: all registered county voters. Sample: the \(500\) selected voters. Random selection is not obviously biased from the information given.
\item
\[
